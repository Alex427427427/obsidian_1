...
The local mechanism of light propagation can be modelled as spherical waves emerging from infinitesimal oscillators everywhere in space, forming wavefronts by superposition. This is Hyugen's principle. 

Fourier optics is the mathematically rigorous application of this idea. The resultant wave amplitude at some detection location, is a sum of spherical waves of the form $e^{ikr}/r$ over a spatial distribution of all sources. We shall carry this analysis through to see the Fourier transform emerge. (Note: the following derives the amplitude of the electric potential; to obtain the electric field, do a spatial derivative with respect to $r$ and end up with an extra $ik$ term at the front, or commonly written as $i2\pi/\lambda$.)
